...
__all__ = ['plt', 'bbox_to_rect', 'semilogy', 'set_figsize', 'show_bboxes',
           'show_images', 'show_trace_2d', 'use_svg_display', 'plot', 'set_axes', 'Animator', 'plot_result']
...
def plot_result(result):
    ...
    marker_size, linewidth = 3, 1.5

    axarr = fig.add_subplot(2, 1, 1)
    axarr.plot(result[0], linewidth=linewidth, marker='', markersize=marker_size,
               label='train loss', color='C0', linestyle='-')
    axarr.plot(result[2], linewidth=linewidth, marker='', markersize=marker_size,
               label='test loss', color='C1', linestyle='-.')
    axarr.legend(loc='best')

    axarr = fig.add_subplot(2, 1, 2)
    axarr.plot(result[1], linewidth=linewidth, marker='', markersize=marker_size,
               label='train acc', color='C0', linestyle='-')
    axarr.plot(result[3], linewidth=linewidth, marker='', markersize=marker_size,
               label='test acc', color='C1', linestyle='-.')
    axarr.legend(loc='best')
